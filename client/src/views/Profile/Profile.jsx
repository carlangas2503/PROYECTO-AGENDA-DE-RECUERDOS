            ...
            <div className={style.countInfo}>
                <div className={style.countInter}>
                    <div className={style.front}>
                        <img src={user.Fondo || "https://images.unsplash.com/photo-1511207538754-e8555f2bc187?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=88672068827eaeeab540f584b883cc66&auto=format&fit=crop&w=1164&q=80"} className={style.background_foto} alt='' />
